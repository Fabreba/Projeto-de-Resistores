...
import br.com.fabreba.projetoresistores.R;
import br.com.fabreba.projetoresistores.TelaInicial;
...
public class MainActivity2 extends AppCompatActivity  {
    ...
    public void main(View view){
        ...
        try {
            ...
            searchString = ""+resultadoDouble+unidadeFinal;
            Button BtSearch = findViewById(R.id.button7);
            BtSearch.setVisibility(View.VISIBLE);
            Toast.makeText(this, "Clique no botão para pesquisar", Toast.LENGTH_SHORT).show();
        }
        catch (Exception e){
    ...
    public void searchNet(View view){
        try{
            Uri uri = Uri.parse("https://br.mouser.com/c/?q="+this.searchString);
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            intent.putExtra(SearchManager.QUERY,this.searchString);
